...
import CourseCreateModel from '../../pages/Courses/components/CourseCreateModel';
import ModalCreateAccount from '../../pages/accounts/components/ModalCreateAccount';
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === 'account' ||
                          pathname.includes('dashboard')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li className='my-[-22px]'>
                            <span className='ms-4'>
                              <ModalCreateAccount style={'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white '
                              } />
                            </span>
                          </li>
                        </ul>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col  pl-6">
                          <li>
                            <NavLink
                              to="courses"
                              className={({ isActive }) =>
                          ...
                          <li className='mt-[-18px]'>
                            <span className='ms-4 '>
                              <CourseCreateModel style={'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white '} />
                            </span>
                          </li>
                        </ul>
                      </div>
